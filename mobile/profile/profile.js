...
// validate email
if (JSON.parse(localStorage.userProfileData).profile.email) document.querySelector("#username div.email").hidden = true
else document.querySelector("#username div.phone").hidden = true
