function productHTML(view,data,lr,minimum=false) {
    ...
    <div class="lcs ${lcs_item}">
        ...
        <button id="share" onclick="lcs.share(this);"><img src="${ROOT_CDN}/static/images/share.svg" alt="share"></button>
        <button hidden id="comment" onclick="lcs.comment(this);"><img src="${ROOT_CDN}/static/images/comment.svg" alt="comment"></button>
    </div>
    `;
    const section_list = `
    <section class="list ${veiws.list}">
        <div class="left product-img">${link}<img src=${img_src} alt="product" onerror="this.src = ROOT_CDN+'/static/images/phone.svg'"></a></div>
        <div class="right">
        ...
        <div class="menu" onclick="lcs.call(this);"><img src="${ROOT_CDN}/static/images/menu.svg" alt="menu"></div>
    </section>
    `;
    const section_item = `
    <section class="item ${veiws.item}">
        <div class="r1">
            <div class="product-img">${link}<img src=${img_src} alt="product" onerror="this.src = ROOT_CDN+'/static/images/phone.svg'"></a></div>
            <div class="product-colors">
                <div style="background:${data.color[0]};"></div>
                <div style="background:${data.color[1]};"></div>
                <div style="background:${data.color[2]};"></div>
